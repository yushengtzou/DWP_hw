...
<body>
    ...
    <div>
        ...
        <h3>
            ...
            Please fill out all the fields in the following form:</h3>
        <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" 
           ...
           <asp:TabPanel runat="server" HeaderText="Contact" ID="TabPanel2">
              <ContentTemplate>
                 <table class="style1">
                    <tr valign="top">
                       <td>
                       ...
                       <td>
                          ...
                          &nbsp;e.g., email@domain.com<br /> &nbsp;&nbsp;<asp:RequiredFieldValidator 
                    ...
                    <tr valign="top">
                       ...
                       <td>
                          ...
                          &nbsp;e.g., (555) 555-1234<br />&nbsp;<asp:RequiredFieldValidator 
